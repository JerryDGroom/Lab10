...
*******************************************************************
Laboratory 10
Hash Table Lab || Group Project                       test10.cpp
...
{
    unsigned int val = 0; // the value calculated by the hash function

    // implement the hash function described at top of page 123 <---------------------------------------- do this
    // HINT: str[n] will give you the ASCII value of the nth character in str
